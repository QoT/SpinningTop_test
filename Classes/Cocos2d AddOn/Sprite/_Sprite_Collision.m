...
//		glReadPixels(0, 0, Width, Height, GL_RGBA, GL_UNSIGNED_BYTE, RawSelfData);
...
//		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
		...
		for (int i = 0; i < Height * Width; i += ACCURACY)
...
//		[TestImage runAction: [CCRotateBy actionWithDuration: 50 angle: 3600]];
		[self scheduleUpdate];
	}
	return self;
}
